...
export default function GuestDashboard() {
  return (
    <div className="min-h-screen bg-[#f4f4f2]">
      <nav className="sticky top-0 z-50 w-full border-b border-slate-200/60 bg-white/95 backdrop-blur">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="relative max-w-2xl mx-auto mb-10">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50/60 py-3 pl-10 pr-4 text-sm focus:outline-none focus:border-[#DC2626]/40 focus:bg-white focus:shadow-glow transition-all duration-200"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          {[
            ...
            <Card key={item.title} className="p-6 text-center hover:shadow-lift transition-all duration-300">
        ...
        <Card title="Featured Services" description="Popular tutors and transport providers in Guwahati">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={service.name} className="p-4 rounded-xl border border-slate-200/60 hover:shadow-lift transition-shadow">
